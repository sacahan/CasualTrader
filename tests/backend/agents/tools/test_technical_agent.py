...
class TestTechnicalAgent:
    ...
    def test_as_tool_method_exists(self):
        ...
        try:
            ...
            pytest.skip("TechnicalAgent not available")
    ...
    def test_tool_configuration_parameters(self):
        ...
        try:
            ...
            agent = TechnicalAgent()
            tool_config = agent.as_tool("technical_analysis", "技術分析")
            ...
            assert "analysis_period" in properties
            assert "include_patterns" in properties
