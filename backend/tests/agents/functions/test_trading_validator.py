...
class TestTradingValidator:
    ...
    def test_as_tool_method_exists(self):
        """測試 as_tool 方法存在"""
        try:
            from agents.functions.trading_validator import TradingValidator
            ...
            assert tool_config["function"]["name"] == "validate_trading_decision"
    ...
    def test_tool_configuration_parameters(self):
        ...
        try:
            ...
            assert "analysis_summary" in properties
